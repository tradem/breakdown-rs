...
Automate dependency updates through Dependabot for both Cargo crate dependencies and GitHub Actions versions. This reduces manual maintenance overhead and ensures dependencies stay current with security patches and bug fixes.
