...
#[openapi(
    ...
    paths(
        ...
        // SceneShoot execution (Soll/Ist day board) — issue #333.
        handlers::plan_scene_shoot,
        handlers::replan_scene_shoot,
        handlers::get_scene_shoot,
        handlers::list_scene_shoots,
        handlers::start_scene_shoot,
        handlers::set_actual_order,
        handlers::finish_scene_shoot,
        handlers::skip_scene_shoot,
        // SceneShoot notes
        handlers::add_scene_shoot_note,
        handlers::update_scene_shoot_note,
        handlers::remove_scene_shoot_note,
        // Continuity photos
        handlers::link_continuity_photo,
        handlers::list_continuity_photos,
        handlers::unlink_continuity_photo,
        // ShootingDay lifecycle
        handlers::wrap_shooting_day,
        // JSON report routes (non-PDF twins of the PDF report endpoints)
        handlers::dispo_report,
        handlers::shoot_day_report,
        handlers::soll_ist_report,
    ),
    components(schemas(
        ...
        handlers::StartSceneShootRequest,
        handlers::SetActualOrderRequest,
        handlers::FinishSceneShootRequest,
        handlers::SkipSceneShootRequest,
        handlers::AddNoteRequest,
        handlers::UpdateNoteRequest,
        handlers::LinkContinuityPhotoRequest,
        handlers::WrapShootingDayRequest,
        breakdown_core::shared::SceneShootId,
        breakdown_core::shared::SceneShootStatus,
        breakdown_core::scene_shoot::views::SceneShootView,
        breakdown_core::scene_shoot::views::SerializedNote,
        breakdown_core::scene_shoot::views::DispoRow,
