...
class $ShellStateRowsTable extends ShellStateRows
    with TableInfo<$ShellStateRowsTable, ShellStateRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ShellStateRowsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [key, value, cachedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'shell_state_rows';
  @override
  VerificationContext validateIntegrity(
    Insertable<ShellStateRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  ShellStateRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ShellStateRow(
  ...
  @override
  $ShellStateRowsTable createAlias(String alias) {
    return $ShellStateRowsTable(attachedDatabase, alias);
  }
}

class ShellStateRow extends DataClass implements Insertable<ShellStateRow> {
  ...
  ShellStateRowsCompanion toCompanion(bool nullToAbsent) {
    return ShellStateRowsCompanion(
      key: Value(key),
      value: Value(value),
      cachedAt: Value(cachedAt),
    );
  ...
  factory ShellStateRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ShellStateRow copyWith({String? key, String? value, DateTime? cachedAt}) =>
      ShellStateRow(
        key: key ?? this.key,
        value: value ?? this.value,
        cachedAt: cachedAt ?? this.cachedAt,
      );
  ShellStateRow copyWithCompanion(ShellStateRowsCompanion data) {
    return ShellStateRow(
  ...
  @override
  String toString() {
    return (StringBuffer('ShellStateRow(')
          ..write('key: $key, ')
          ..write('value: $value, ')
          ..write('cachedAt: $cachedAt')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(key, value, cachedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ShellStateRow &&
          other.key == this.key &&
          other.value == this.value &&
          other.cachedAt == this.cachedAt);
}

class ShellStateRowsCompanion extends UpdateCompanion<ShellStateRow> {
  final Value<String> key;
  final Value<String> value;
  final Value<DateTime> cachedAt;
  final Value<int> rowid;
  const ShellStateRowsCompanion({
  ...
  ShellStateRowsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       value = Value(value),
       cachedAt = Value(cachedAt);
  static Insertable<ShellStateRow> custom({
  ...
  ShellStateRowsCompanion copyWith({
    Value<String>? key,
    Value<String>? value,
    Value<DateTime>? cachedAt,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('ShellStateRowsCompanion(')
          ..write('key: $key, ')
          ..write('value: $value, ')
          ..write('cachedAt: $cachedAt, ')
          ..write('rowid: $rowid')
...
abstract class _$CacheDatabase extends GeneratedDatabase {
  ...
  late final $ShellStateRowsTable shellStateRows = $ShellStateRowsTable(this);
  @override
...
typedef $$AiImportJobCacheRowsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$ShellStateRowsTableCreateCompanionBuilder =
    ShellStateRowsCompanion Function({
      required String key,
      required String value,
      required DateTime cachedAt,
      Value<int> rowid,
    });
typedef $$ShellStateRowsTableUpdateCompanionBuilder =
    ShellStateRowsCompanion Function({
      Value<String> key,
      Value<String> value,
      Value<DateTime> cachedAt,
...
class $$ShellStateRowsTableFilterComposer
    extends Composer<_$CacheDatabase, $ShellStateRowsTable> {
  $$ShellStateRowsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ShellStateRowsTableOrderingComposer
    extends Composer<_$CacheDatabase, $ShellStateRowsTable> {
  $$ShellStateRowsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ShellStateRowsTableAnnotationComposer
    extends Composer<_$CacheDatabase, $ShellStateRowsTable> {
  $$ShellStateRowsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ShellStateRowsTableTableManager
    extends
        RootTableManager<
          _$CacheDatabase,
          $ShellStateRowsTable,
          ...
          $$ShellStateRowsTableOrderingComposer,
          $$ShellStateRowsTableAnnotationComposer,
          $$ShellStateRowsTableCreateCompanionBuilder,
          $$ShellStateRowsTableUpdateCompanionBuilder,
          (
            ShellStateRow,
            BaseReferences<
              _$CacheDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$ShellStateRowsTableTableManager(
    _$CacheDatabase db,
    $ShellStateRowsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ShellStateRowsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ShellStateRowsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ShellStateRowsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $$ShellStateRowsTableProcessedTableManager =
    ProcessedTableManager<
      _$CacheDatabase,
      $ShellStateRowsTable,
      ShellStateRow,
      ...
      (
        ShellStateRow,
        BaseReferences<_$CacheDatabase, $ShellStateRowsTable, ShellStateRow>,
      ),
      ShellStateRow,
      PrefetchHooks Function()
    >;
...
class $CacheDatabaseManager {
  ...
  $$ShellStateRowsTableTableManager get shellStateRows =>
      $$ShellStateRowsTableTableManager(_db, _db.shellStateRows);
}
