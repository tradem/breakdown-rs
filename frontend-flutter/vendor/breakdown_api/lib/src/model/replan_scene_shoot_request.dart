...
part 'replan_scene_shoot_request.g.dart';
...
@BuiltValue()
abstract class ReplanSceneShootRequest
    implements Built<ReplanSceneShootRequest, ReplanSceneShootRequestBuilder> {
  ...
  ReplanSceneShootRequest._();

  factory ReplanSceneShootRequest(
          [void updates(ReplanSceneShootRequestBuilder b)]) =
      _$ReplanSceneShootRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReplanSceneShootRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReplanSceneShootRequest> get serializer =>
      _$ReplanSceneShootRequestSerializer();
}

class _$ReplanSceneShootRequestSerializer
    implements PrimitiveSerializer<ReplanSceneShootRequest> {
  @override
  ...
  @override
  final String wireName = r'ReplanSceneShootRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ReplanSceneShootRequest object, {
  ...
  void _deserializeProperties(
    ...
    required ReplanSceneShootRequestBuilder result,
  ...
  @override
  ReplanSceneShootRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ReplanSceneShootRequestBuilder();
