...
class HandlersApi {
  ...
  const HandlersApi(this._dio, this._serializers);

  /// Accept a pending invitation for the authenticated caller.
  /// Self-service: the invitee proves who they are via OIDC and the command binds &#x60;user_id&#x60; to the authenticated &#x60;sub&#x60;, so a caller can only accept their own invitation. Gated &#x60;Authenticated&#x60; (not &#x60;BlockMember&#x60;) because the invitee is not yet an active member; the domain command enforces that a pending invitation exists for this block.
  ///
  /// Parameters:
  /// * [id] - Block id
  ...
  Future<Response<void>> acceptInvitation({
    required String id,
    ...
    final _path = r'/v1/blocks/{id}/members/accept'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> addCostumeDetail({
    required String id,
    required AddCostumeDetailRequest addCostumeDetailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/costumes/{id}/details'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApplyAiImportResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApplyAiImportResponse>> applyAiImport({
    required String id,
    required ApplyAiImportRequest applyAiImportRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/ai-import/jobs/{id}/apply'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(ApplyAiImportRequest);
      _bodyData =
          _serializers.serialize(applyAiImportRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    ApplyAiImportResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApplyAiImportResponse),
            ) as ApplyAiImportResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApplyAiImportResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> archiveCostumeCategory({
    required String id,
    ...
    final _path = r'/v1/costume-categories/{id}/archive'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> archiveShootingDay({
    required String id,
    required VersionRequest versionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/shooting-days/{id}/archive'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> assignCostume({
    required String id,
    required AssignCostumeRequest assignCostumeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/costumes/{id}/assign'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(AssignCostumeRequest);
      _bodyData =
          _serializers.serialize(assignCostumeRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> assignSceneCharacter({
    required String id,
    required AssignCharacterRequest assignCharacterRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/scenes/{id}/characters'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(AssignCharacterRequest);
      _bodyData =
          _serializers.serialize(assignCharacterRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createAiConfig({
    required CreateAiConfigRequest createAiConfigRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateAiConfigRequest);
      _bodyData =
          _serializers.serialize(createAiConfigRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createBlock({
    required CreateBlockRequest createBlockRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateBlockRequest);
      _bodyData =
          _serializers.serialize(createBlockRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createCharacter({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createCharacterRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createCostumeCategory({
    required String seasonId,
    required CreateCostumeCategoryRequest createCostumeCategoryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/seasons/{season_id}/costume-categories'.replaceAll(
        '{' r'season_id' '}',
    ...
    try {
      const _type = FullType(CreateCostumeCategoryRequest);
      _bodyData = _serializers.serialize(createCostumeCategoryRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createCredential({
    ...
    final _path = r'/v1/settings/credentials';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createCredentialRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createEpisode({
    required CreateEpisodeRequest createEpisodeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateEpisodeRequest);
      _bodyData =
          _serializers.serialize(createEpisodeRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createGdriveCredential({
    required GDriveCredentialRequest gDriveCredentialRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/settings/gdrive';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GDriveCredentialRequest);
      _bodyData =
          _serializers.serialize(gDriveCredentialRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createScene({
    required CreateSceneRequest createSceneRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSceneRequest);
      _bodyData =
          _serializers.serialize(createSceneRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createSeason({
    required CreateSeasonRequest createSeasonRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSeasonRequest);
      _bodyData =
          _serializers.serialize(createSeasonRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> createShootingDay({
    required String episodeId,
    required CreateShootingDayRequest createShootingDayRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/episodes/{episode_id}/shooting-days'.replaceAll(
        '{' r'episode_id' '}',
        encodeQueryParameter(_serializers, episodeId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      const _type = FullType(CreateShootingDayRequest);
      _bodyData = _serializers.serialize(createShootingDayRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Authorization is checked per-request via season-scoped membership. The photo bytes are only deleted when the refcount reaches zero.
  ///
  /// Parameters:
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCostumePhoto({
    ...
    final _path = r'/v1/costumes/{costume_id}/photos/{photo_id}'
        .replaceAll(
            '{' r'costume_id' '}',
            encodeQueryParameter(
                    _serializers, costumeId, const FullType(String))
                .toString())
        .replaceAll(
            '{' r'photo_id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AiConfigView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AiConfigView>> getAiConfig({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/ai-import/config/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AiConfigView),
            ) as AiConfigView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AiImportJobResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AiImportJobResponse>> getAiImportJob({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/ai-import/jobs/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    AiImportJobResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AiImportJobResponse),
            ) as AiImportJobResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<AiImportJobResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AiImportPreviewResponse>> getAiImportPreview({
    ...
    final _path = r'/v1/ai-import/jobs/{id}/preview'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BlockView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BlockView>> getBlock({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/blocks/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BlockView),
            ) as BlockView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<AuditEntry>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<AuditEntry>>> getBlockAudit({
    required String id,
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    ...
    final _path = r'/v1/blocks/{id}/audit'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CharacterView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CharacterView>> getCharacter({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/characters/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CharacterView),
            ) as CharacterView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CostumeView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CostumeView>> getCostume({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/costumes/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CostumeView),
            ) as CostumeView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Authorization is checked on every request via season-scoped membership. The response includes &#x60;Cache-Control: private, max-age&#x3D;300&#x60;.
  ///
  /// Parameters:
  /// * [costumeId] - Costume id
  /// * [photoId] - Photo id
  /// * [variant] - Variant: original, thumb, or medium
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<Uint8List>> getCostumePhotoBytes({
    ...
    final _path = r'/v1/costumes/{costume_id}/photos/{photo_id}/bytes'
        .replaceAll(
            '{' r'costume_id' '}',
            encodeQueryParameter(
                    _serializers, costumeId, const FullType(String))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EpisodeView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EpisodeView>> getEpisode({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/episodes/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EpisodeView),
            ) as EpisodeView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MembershipView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MembershipView>> getMember({
    required String id,
    ...
    final _path = r'/v1/blocks/{id}/members/{user_id}'
        .replaceAll(
            '{' r'id' '}',
            encodeQueryParameter(_serializers, id, const FullType(String))
                .toString())
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(MembershipView),
            ) as MembershipView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SceneView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SceneView>> getScene({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/scenes/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SeasonView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SeasonView>> getSeason({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/seasons/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SeasonView),
            ) as SeasonView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SeasonMembershipDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SeasonMembershipDto>> getSeasonMembership({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/seasons/{id}/membership'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    SeasonMembershipDto? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SeasonMembershipDto),
            ) as SeasonMembershipDto;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<SeasonMembershipDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SettingsView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SettingsView>> getSettings({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/settings/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SettingsView),
            ) as SettingsView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ShootingDayView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ShootingDayView>> getShootingDay({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/shooting-days/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ShootingDayView),
            ) as ShootingDayView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
    ...
    return Response<ShootingDayView>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> grantRole({
    required String id,
    required String userId,
    required GrantRoleRequest grantRoleRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/blocks/{id}/members/{user_id}/role'
        .replaceAll(
            '{' r'id' '}',
            encodeQueryParameter(_serializers, id, const FullType(String))
                .toString())
    ...
    try {
      const _type = FullType(GrantRoleRequest);
      _bodyData =
          _serializers.serialize(grantRoleRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Gated &#x60;BlockMember&#x60;: the caller must be an active member of the active block (see &#x60;authorize_middleware&#x60;). The actor is the authenticated caller.
  ///
  /// Parameters:
  /// * [id] - Block id
  /// * [inviteMemberRequest]
  ...
  Future<Response<void>> inviteMember({
    ...
    final _path = r'/v1/blocks/{id}/members'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(inviteMemberRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Leave the block (self-service). The authenticated caller removes themselves; the actor is supplied as command metadata by the adapter.
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> leaveBlock({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/blocks/{id}/members/leave'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ModelInfo>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ModelInfo>>> listAiModels({
    ...
    final _path = r'/v1/ai-import/providers/{provider}/models'.replaceAll(
        '{' r'provider' '}',
    ...
    BuiltList<ModelInfo>? _responseData;
    ...
    return Response<BuiltList<ModelInfo>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AiProviderInfo>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<AiProviderInfo>>> listAiProviders({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/ai-import/providers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<AiProviderInfo>? _responseData;
    ...
    return Response<BuiltList<AiProviderInfo>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<BlockView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BlockView>>> listBlocks({
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    String? seasonId,
    ...
    BuiltList<BlockView>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(BlockView)]),
            ) as BuiltList<BlockView>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<BlockView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CharacterView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CharacterView>>> listCharacters({
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    String? seasonId,
    ...
    BuiltList<CharacterView>? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CostumeCategoryView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CostumeCategoryView>>> listCostumeCategories({
    required String seasonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<CostumeCategoryView>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<CostumeCategoryView>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<CostumeCategoryView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CostumeView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CostumeView>>> listCostumes({
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    String? seasonId,
    ...
    BuiltList<CostumeView>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(CostumeView)]),
            ) as BuiltList<CostumeView>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<CostumeView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<EpisodeView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<EpisodeView>>> listEpisodes({
    ...
    BuiltList<EpisodeView>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(EpisodeView)]),
            ) as BuiltList<EpisodeView>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<EpisodeView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<MembershipView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<MembershipView>>> listMembers({
    required String id,
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    ...
    BuiltList<MembershipView>? _responseData;
    ...
    return Response<BuiltList<MembershipView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SceneView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SceneView>>> listScenes({
    int? limit = 50,
    int? offset = 0,
    String? episodeId,
    String? seasonId,
    ...
    BuiltList<SceneView>? _responseData;
    ...
    return Response<BuiltList<SceneView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SeasonView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SeasonView>>> listSeasons({
    ...
    BuiltList<SeasonView>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(SeasonView)]),
            ) as BuiltList<SeasonView>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<SeasonView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ShootingDayView>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ShootingDayView>>> listShootingDays({
    required String episodeId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BuiltList<ShootingDayView>? _responseData;
    ...
    return Response<BuiltList<ShootingDayView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] - Block id
  /// * [userId] - OIDC sub of the member to remove
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<int>> removeSceneCharacter({
    ...
    final _path = r'/v1/scenes/{id}/characters/{character_id}'
        .replaceAll(
            '{' r'id' '}',
            encodeQueryParameter(_serializers, id, const FullType(String))
                .toString())
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> renameEpisode({
    required String id,
    required RenameEpisodeRequest renameEpisodeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/episodes/{id}/name'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(RenameEpisodeRequest);
      _bodyData =
          _serializers.serialize(renameEpisodeRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> renameSeason({
    required String id,
    required RenameSeasonRequest renameSeasonRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/seasons/{id}/name'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> revokeAiConfig({
    required String id,
    required RevokeAiConfigRequest revokeAiConfigRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/ai-import/config/{id}/revoke'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(RevokeAiConfigRequest);
      _bodyData =
          _serializers.serialize(revokeAiConfigRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> revokeSettings({
    required String id,
    required VersionRequest versionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IdVersionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdVersionResponse>> rotateGdriveCredential({
    required String id,
    required GDriveCredentialUpdateRequest gDriveCredentialUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/settings/{id}/gdrive'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(GDriveCredentialUpdateRequest);
      _bodyData = _serializers.serialize(gDriveCredentialUpdateRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> scheduleSceneOnShootingDay({
    required String id,
    required ScheduleSceneRequest scheduleSceneRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/scenes/{id}/shooting-days'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(ScheduleSceneRequest);
      _bodyData =
          _serializers.serialize(scheduleSceneRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<int>> unassignCostume({
    ...
    final _path = r'/v1/costumes/{id}/unassign'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<int>> unscheduleSceneFromShootingDay({
    ...
    final _path = r'/v1/scenes/{id}/shooting-days/{shooting_day_id}'
        .replaceAll(
            '{' r'id' '}',
            encodeQueryParameter(_serializers, id, const FullType(String))
                .toString())
        .replaceAll(
            '{' r'shooting_day_id' '}',
            encodeQueryParameter(
                    _serializers, shootingDayId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateAiConfig({
    required String id,
    required UpdateAiConfigRequest updateAiConfigRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateAiConfigRequest);
      _bodyData =
          _serializers.serialize(updateAiConfigRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateBlockTimeSpan({
    required String id,
    required UpdateBlockTimeSpanRequest updateBlockTimeSpanRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/blocks/{id}/time-span'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(UpdateBlockTimeSpanRequest);
      _bodyData = _serializers.serialize(updateBlockTimeSpanRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateContactInfo({
    required String id,
    required UpdateContactInfoRequest updateContactInfoRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/characters/{id}/contact'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(UpdateContactInfoRequest);
      _bodyData = _serializers.serialize(updateContactInfoRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateCostumeCategory({
    required String id,
    required UpdateCostumeCategoryRequest updateCostumeCategoryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/costume-categories/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateCostumeNotes({
    required String id,
    ...
    final _path = r'/v1/costumes/{id}/notes'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateMeasurements({
    required String id,
    required UpdateMeasurementsRequest updateMeasurementsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/characters/{id}/measurements'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateSceneDetails({
    required String id,
    required UpdateSceneDetailsRequest updateSceneDetailsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/scenes/{id}/details'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(UpdateSceneDetailsRequest);
      _bodyData = _serializers.serialize(updateSceneDetailsRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> updateShootingDay({
    required String id,
    required UpdateShootingDayRequest updateShootingDayRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateShootingDayRequest);
      _bodyData = _serializers.serialize(updateShootingDayRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> uploadAiSchedule({
    ...
    final _path = r'/v1/ai-import/schedules';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> uploadAiScript({
    required String body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/ai-import/scripts';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// The request body is raw image bytes; the &#x60;Content-Type&#x60; header MUST be one of &#x60;image/jpeg&#x60;, &#x60;image/png&#x60;, or &#x60;image/webp&#x60;. HEIC/HEIF is rejected with 415. The file size MUST NOT exceed &#x60;PHOTO_MAX_SIZE_MB&#x60; (default 20 MB). Authorization is checked per-request via season-scoped membership.
  ///
  /// Parameters:
  /// * [costumeId] - Costume id
  /// * [body] - Raw image bytes (JPEG/PNG/WebP)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PhotoView] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PhotoView>> uploadCostumePhoto({
    required String costumeId,
    required String body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/costumes/{costume_id}/photos'.replaceAll(
        '{' r'costume_id' '}',
        encodeQueryParameter(_serializers, costumeId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PhotoView),
            ) as PhotoView;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
